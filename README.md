...
* **AI Infra**：掌握AI Infra相关技术栈，**独立开发[🔗Needle](https://github.com/Nicooo-Wang/Needle)神经网络推理库**。了解CUDA和OpenCL算子开发，熟悉反向传播算法及常用高性能算子优化，如Conv(im2col高并行度)、Matmul (2D tiling 达到cuBLAS 70性能)。
...
**项目背景**：AI-HAL 是专为 TVOS 和 HL 平台设计的 C API 模块，旨在实现神经网络推理的高效运行，支持多家 AI 生态的导入。
